...
#            return True
    ...
    def send_email_awaiting(self,cr,uid,ids,context=None):
        ...
        print"compose_form_idddddddddddddddddddd",compose_form_id
        ctx = dict(context)
	print"ctx",ctx
        ctx.update({
	...
	print "ctxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",ctx
        return {
...
#                }
                ...
                'report_name': 'appl.snap2',
                'datas': datas, 'nodestroy': True}
                ir_attachment = self.pool.get('ir.attachment')
                service = netsvc.LocalService('report.appl.snap2')
