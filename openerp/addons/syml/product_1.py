...
#        'compensation':fields.many2one('product.compensation','Compensation'),
        ...
        'cash_back':fields.float('Cash Back Pecentage'),
        ...
        'is_penalty_greater':fields.boolean('Is Penalty Greater of'),
        'months_interest_penalty': fields.integer('Months Interest Penalty',),
        'avg_diff_used': fields.float('Avd Differential Used',),
        ...
        'cost_period':fields.integer('Cost Period (Months)'),
        ...
        '2_yr_avg_noa_percent':fields.boolean('2 Yr Average NOA + Percent'),
        'se_grossup_percent':fields.float('S/E Gross Up Percentage'),
        'last_yr_noa':fields.boolean('Last Yr NOA'),
        ...
        'child_support_treatment':fields.boolean('Child Support Treatment'),
        'child_tax_credit':fields.boolean('Child Tax Credit % Allowed'),
        'living_allowance':fields.boolean('Living Allowance % Allowed'),
        'vehicle_allowance':fields.boolean('Vehicle Allowance % Allowed'),
        ...
        'outbuilding_included':fields.boolean('% outbuilding included'),
